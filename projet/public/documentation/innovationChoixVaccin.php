    ...
    <div class="container">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <p>Ensuite, l'attribution des rendez vous ce gère via les même fonctionnalités que la gestion des rendez vous classique. Ensuite évidemment, le dossier de ce patient nouvellement vacciné est également gérable via l'outil gestion de rendez vous</p>
                <p>D'un point de vue technique, nous avons essayé au maximum de réutiliser les fonctionnalités implémentées dans la partie commune du projet. Nous avons pour cela mis à profit l'amélioration du rooter2 mis au point lors du devoir 12. Nous ainsi utilisé les target. Une des difficulté dans la mis en place de cette innovation fût le fait que nous devions gérer la transition des informations recueillies dans chaque formulaire et pouvoir les conserver tout au long du processus jusqu'à la gestion des rendez vous par le ControllerRendezVous. </p>
