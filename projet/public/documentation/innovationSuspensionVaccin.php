        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <p>Cette innovation a pour but de permettre à l'utilisateur de suspendre un vaccin, il peut également lever cette suspension.
                    Cela nous semblait intéréssant à mettre en place dans un but de fidélité avec la situation de vaccination dans le monde. En effet, certains vaccins ont déjà été réellement suspendu : AstraZeneca en France Janssen aux Etats Unis.
                </p>   
                <p>Si l'utilisateur souhaite désactivé un vaccin, il peut choisir, ou non, de vider l'ensemble des stocks liés à ce vaccin.</p>
                <p>Si jamais un vaccin est désactivé, alors le nombre de dose qu'il nécessite devient égale à 0, ce qui permet de l'identifier comme étant un vaccin désactivé.</p>
                <p>Cette innovation permets également à l'utilisateur de réactiver un vaccin désactivé. En le réactivant, l'utilisateur doit choisir combien de dose le vaccin nécessite désormais.</p>
